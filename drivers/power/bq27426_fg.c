...
static const struct fg_batt_profile bqfs_image[] = {
	{ bqfs_scud, ARRAY_SIZE(bqfs_scud), 5 },//30
	{ bqfs_nvt, ARRAY_SIZE(bqfs_nvt), 3 },//100
	{ bqfs_sunwoda, ARRAY_SIZE(bqfs_sunwoda), 5 },//330
};
